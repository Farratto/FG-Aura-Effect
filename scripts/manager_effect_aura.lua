...
-- luacheck: globals AuraFactionConditional.DetectedEffectManager.hasEffectCondition
bDebug = false
...
--		aTokens = AuraToken.getTokensWithinCube(tokenSource, rAuraDetails.nRange)
	...
	elseif rAuraDetails.b3Drect then
		aTokens = AuraToken.getTokensWithinShape(rAuraDetails.bPoint, 2, tokenSource, rAuraDetails.nRange, tonumber(rAuraDetails.aParameters[2]),tonumber(rAuraDetails.aParameters[3]), tonumber(rAuraDetails.aParameters[4]), tonumber(rAuraDetails.aParameters[5]))
	...
	elseif rAuraDetails.bCylinder then
		aTokens = AuraToken.getTokensWithinShape(rAuraDetails.bPoint, 1, tokenSource, rAuraDetails.nRange, tonumber(rAuraDetails.aParameters[2]),tonumber(rAuraDetails.aParameters[3]), tonumber(rAuraDetails.aParameters[4]))
	else
